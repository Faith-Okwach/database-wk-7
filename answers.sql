...
-- Creating a new table where each row represents a single product for an order
...
-- Inserting data into the 1NF table by splitting the Products column
...
-- Step 1: Create a Customers table to store CustomerName with OrderID
